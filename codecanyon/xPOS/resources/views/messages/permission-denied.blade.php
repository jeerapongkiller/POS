                ...
                @guest
                    @else
                        ...
                        <ul class="nav navbar-nav hidden-xs">
                            <li>
                                <a href="">
                                    <img id="loading" style="margin-left: 355px" height="60px"
                                         src="{{url('/images/loading-2.gif')}}" alt="">
                                </a>
                            </li>
                        </ul>
                        @endguest
                                    ...
                                    <li class="dropdown top-menu-item-xs">
                                        <a href="" class="dropdown-toggle profile waves-effect waves-light"
                                           ...
                                           aria-expanded="true"><img
                                                    src="{{url(auth()->user()->image != '' || auth()->user()->image != null ? auth()->user()->image : '/images/placeholder.png' )}}"
                                                    alt="user-img"
                                                    class="img-circle"> </a>
...
<div class="an_container">
    ...
    <button class="redirect " onclick="window.location.replace('{{url('/home')}}')">go back to main site</button>
</div>
