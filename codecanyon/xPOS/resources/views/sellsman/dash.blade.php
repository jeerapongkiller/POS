        ...
        <div class="col-md-12">
            <div class="card-box">
                <div class="text-center">
                    <div id="qrcode"></div>
                    <p>You can print his QR Code and place it in-front of your outlet so your customer can directly
                        order by scan it.</p>
    ...
    <div class="row should-not-print">
        ...
        <div class="col-md-12 col-lg-6">
            <a href="{{url('/outlet/id='.$outlet_id.'/products')}}">
                <div class="widget-bg-color-icon card-box">
                    <div class="bg-icon bg-icon-success pull-left">
                        <i class="md md-print text-success"></i>
                    </div>
                    <div class="text-right">
                        <h3 class="text-dark"><b class="counter">PRODUCTS</b></h3>
                        <p class="text-muted">Click to make see products</p>
                    </div>
                    <div class="clearfix"></div>
                </div>
            </a>
