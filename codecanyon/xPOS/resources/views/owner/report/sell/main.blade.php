...
@section('content')
                    ...
                    <div class="col-sm-12">
                        ...
                        <form class="form-inline" role="form" id="report" method="post">
                            ...
                            <div class="form-group m-l-10">
                                <label class="sr-only" for="exampleInputPassword2">Report Type</label>
    ...
    @if($type == 0)
        <div class="card-box">
            @include('owner.report.sell.weekly')
        </div>

    @elseif($type == 1)
        <div class="card-box">
            @include('owner.report.sell.monthly')
        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#report").on('submit',function (e) {
                ...
                var type = $("#type").val();
                window.location.replace('/outlet/id='+outlet_id+'/sell-report/start='+start_date+'/end='+end_date+'/type='+type);
            })
        })
    </script>
@endsection
