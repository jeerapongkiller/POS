    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box table-responsive">
                <h4 class="m-t-0 header-title"><b>New Product</b></h4>
                ...
                <form class="form-horizontal" method="post" action="#" role="form" id="productForm"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="product_name" required class="form-control" id="inputProductName"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="product_sku" required class="form-control" id="inputProductSKU"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="number" step="0.01" name="price" required class="form-control" id="inputPrice"
                                   placeholder="Price">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#productForm").on('submit', function (e) {
                ...
                $(this).speedPost('{{url('/outlet/id='.$outlet_id.'/save-product')}}', data, productForm);
            });
        });
    </script>
@endsection
