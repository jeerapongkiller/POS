            ...
            <div class="card-box table-responsive">
                ...
                <form class="form-horizontal" method="post" action="#" role="form" id="outletForm"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <textarea required name="location" id="" cols="30" rows="5" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            ...
                            @empty
                                <p class="form-control-static">No charge added <a href="{{url('/new-charge')}}">Click hear</a> to create outlet charge</p>
                            @endforelse
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <p class="form-control-static">TIN : {{config('app.tin')}} | TAX : {{config('app.tax')}} (%)
                                <a href="javascript:void(0)" data-toggle="modal" data-target=".bs-example-modal-lg">Change tax information</a> </p>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $("#outletForm").on('submit', function (e) {
                ...
                $(this).speedPost('{{url('/save-outlet')}}', data, outletForm);
            })
        })
    </script>
@endsection